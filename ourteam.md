...
โอ๊ตเป็นคนที่ดูจะค่อนข้างเก็บตัวเมื่อเจอสังคมใหม่ๆและคอยพยามพูดติดตลกเพื่อให้บทสนทนาไปต่อได้ และจากเท่าที่ทำงานด้วยกันมาดูเหมือนโอ๊ตไม่ค่อยสันทัดกับเรื่องวิชาการเท่าไหร่ทำให้เวลาต้องทำงานเกี่ยวกับเรื่องใหม่ๆจะต้องใช้เวลาและคอยปรึกษาเพื่อนร่วมทีม โดยรวมแล้วโอ้ตเป็นคนที่ดูร่าเริงเฮฮา ชิลๆ แต่energyเยอะ และติดตลกมากพอสมควร เป็นคนที่คอยสร้างสีสรรค์เล็กๆน้อยๆเวลาอยู่ใน sharing session เพื่อไม่ให้บรรยากาศตึงเครียดเกินไป ตอนนี้เป้าหมายหลักของโอ้ตคือการเรียนยังไงก็ได้ให้จบ :book: (ท้อแท้จัด:sweat_smile:) และโอ้ตเป็นคนที่ใส่ใจและมักคิดมากกับคำพูดของคนอื่น
...
มี่เป็นคนเก่งใส่ใจมากๆมีส่วนร่วมกับกลุ่มทุกอย่าง <br>
นิสัยดี เป็นกันเอง เป้าหมายของมี่คือเรียนให้จบไม่ติดF<br>
และทำงานหาเงินเลี้ยงแมว<br>
